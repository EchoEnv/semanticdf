...
**Status:** v0.1.3 (current) — this spec is the per-field reference for the OKF bundle shipped by `okfgen` (see [`docs/agents/maintenance.md`](maintenance.md) for the regeneration workflow). The post-v0.1.3 fixes (PRs `#61`, `#62`) are library-internal and do not change OKF output.
