...
**Status:** v0.1.6 (current) — this spec is the per-field reference for the OKF bundle shipped by `okfgen` (see [`docs/agents/maintenance.md`](maintenance.md) for the regeneration workflow). The post-v0.1.3 library fixes (PRs `#61`, `#62`) do not change OKF output.
