...
| **CLI** (`sdf`) | Same five verbs, same model-only surface. `sdf query <streaming-model>` runs the filter-only path against the streaming source. The `sdf` binary never starts, stops, or holds a stream. | [`semanticdf-cli/README.md`](../../semanticdf-cli/README.md) §*Streaming models* |
