...
```bash
mvn test                    # runs 278 tests on Spark 3.5.8
mvn -Pspark4 test           # runs 278 tests on Spark 4.1.1
...
release is on the classpath. You should see `Tests: succeeded 278` either way.
