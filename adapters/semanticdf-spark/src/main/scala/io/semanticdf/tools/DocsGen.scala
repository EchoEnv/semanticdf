...
/** Generate browsable HTML documentation from semanticdf YAML model files.
  *
  * Run with:
...
<title>SemanticDF Model Catalog</title>
<style>
...
<footer>Generated by semanticdf docsgen · $ts</footer>
</body>
</html>"""
  }
