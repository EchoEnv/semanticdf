...
private[semantica] case class FlightRow(
    carrier: String,
    origin: String,
    distance: Int,
    passengers: Int,
...
private[semantica] case class FlightWithTimeRow(
...
private[semantica] case class OrderRow(
    order_id: String,
    customer_id: String,
    carrier: String,
    qty: Int,
...
private[semantica] case class CustomerRow(
    customer_id: String,
    name: String,
    city: String,
)

private[semantica] case class LineItemRow(
    order_id: String,
    qty: Int,
    price_cents: Int,
)
