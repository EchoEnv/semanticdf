...
/** Regression tests for io.semantica.tools.DocsGen. */
class DocsGenSpec extends AnyFunSpec with Matchers {

  private val docsGen = new io.semantica.tools.DocsGen()
  ...
  describe("DocsGen") {
    ...
    it("generates valid HTML with doctype and title") {
      ...
      html must include("<title>Semantica Model Catalog</title>")
